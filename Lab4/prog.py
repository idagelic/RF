...
webbrowser.open_new_tab(f"http://www.google.com/maps/place/{convertGPScoordinate(figMetaData(path).gps_latitude, figMetaData(path).gps_latitude_ref)},{+convertGPScoordinate(figMetaData(path).gps_longitude, figMetaData(path).gps_longitude_ref)}")
